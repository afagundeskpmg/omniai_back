...
{
    public class ProcessamentoNerRepositorio : BaseRepositorio<ProcessamentoNer>, IProcessamentoNerRepositorio
    {
        public ProcessamentoNerRepositorio(ContextoBase contexto):base (contexto)
        {
